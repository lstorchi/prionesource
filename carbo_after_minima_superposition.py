...
print "Compute mean fields and minima \"", filenamemol21, "\""

centroids1_1 = elektrofield.compute_meanelek_and_get_centroids (\
        filenamemol21, weifilename1, -1.0, STEPVAL, MINDIM, NUMOFCLUST, DELTAVAL)
centroids1_2 = elektrofield.compute_meanelek_and_get_centroids (\
        filenamemol21, weifilename1, 1.0, STEPVAL, MINDIM, NUMOFCLUST, DELTAVAL)
...
#o_file.write(str(len(centroids1))+"\n")
#o_file.write("centroids 1 \n")
#for i in range(0,len(centroids1)):
#  o_file.write("O   "+str(centroids1[i][0])+" "+\
#          str(centroids1[i][1])+" "+\
#          str(centroids1[i][2])+"\n")
#o_file.close()
#exit()
...
centroids2_1 = elektrofield.compute_meanelek_and_get_centroids (\
        filenamemol22, weifilename2, -1.0, STEPVAL, MINDIM, NUMOFCLUST, DELTAVAL)
centroids2_2 = elektrofield.compute_meanelek_and_get_centroids (\
        filenamemol22, weifilename2, 1.0, STEPVAL, MINDIM, NUMOFCLUST, DELTAVAL)
...
for mol1 in pybel.readfile("mol2", filenamemol21):
...
for mol2 in pybel.readfile("mol2", filenamemol22):
...
carbo.carbo_similarity (fileout1, weifilename1, fileout2, weifilename2, \
